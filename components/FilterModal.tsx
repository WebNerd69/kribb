  ...
  return (
    ...
    >
      <View className="flex-1 bg-gray-50 p-3">
        {/* header */}
        <View className="flex-row justify-between items-center pt-2 px-[10]">
        ...
        >
          ...
          <View className="flex-row flex-wrap gap-3 mb-6">
            {PROPERTY_TYPES.map((item) => {
              return (
                ...
                >
                  <Text className={chipText(localType === item.value)}>
                    {item.label}
                  </Text>
                </TouchableOpacity>
              );
          ...
          <View className="flex-row flex-wrap gap-3 mb-6">
            {BEDS.map((item) => {
              return (
                ...
                >
                  <Text className={chipText(localBedrooms === item.value)}>
                    {item.label}
                  </Text>
                </TouchableOpacity>
              );
          ...
          <View className="flex-2 flex-row gap-3 justify-between mb-5">
            <View className="w-[50%]">
              <Text className="text-lg font-medium mb-2">Min price</Text>
              <TextInput
            ...
            <View className="w-[50%]">
              <Text className="text-lg font-medium mb-2">Max price</Text>
              <TextInput
          ...
          <View className="flex-row flex-wrap gap-3 mb-6">
            {PRICE_PRESET.map((item) => {
              const active = maxPrice === item.max && minPrice === item.min;
              return (
                <TouchableOpacity
